...
<div class="space-y-6">
  ...
  <label class="flex items-center space-x-2 cursor-pointer">
    <input type="checkbox" class="w-5 h-5 rounded border border-gray-400 bg-white checked:bg-white checked:border-gray-400 checked:ring-0 focus:ring-0">
  ...
  <label class="flex items-center space-x-2 cursor-pointer">
    <input type="checkbox" checked="" class="w-5 h-5 rounded border border-gray-400 bg-white checked:bg-white checked:border-gray-400 checked:ring-0 focus:ring-0">
