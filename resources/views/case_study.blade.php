...
@section('content')
  ...
  <section class="bg-gradient-to-r from-[#070648] to-[#2CBE9D] text-white">
    <div class="max-w-7xl mx-auto px-6 py-20 sm:py-24 lg:py-28">
      ...
      <h1 class="text-3xl sm:text-5xl font-extrabold leading-none max-w-[500px]">
       Learn from water PPP success stories
      </h1>
    </div>
  </section>
  <section class=" px-6  mt-[40px] lg:mt-[80px] lg:px-16">
    <div class="max-w-7xl mx-auto flex  flex-wrap items-center gap-4 lg:gap-8">
        ...
        <div class="">
            ...
            <label for="countryToggle"
                ...
                Country <svg id="chevron-right-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <rect id="Rectangle_66" data-name="Rectangle 66" width="24" height="24" fill="none"/>
                <path id="Path_410" data-name="Path 410" d="M12.6,12,8,7.4,9.4,6l6,6-6,6L8,16.6,12.6,12Z" fill="#ababab"/>
                </svg>
            </label>
        ...
        <div class="relative">
            ...
            <label for="phaseToggle"
                class="flex items-center justify-between bg-[#F3F3F3] text-[#1C1C3C] px-6 py-3 rounded-full w-[286px] text-sm cursor-pointer select-none">
                Phase of project <svg id="chevron-right-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <rect id="Rectangle_66" data-name="Rectangle 66" width="24" height="24" fill="none"/>
                <path id="Path_410" data-name="Path 410" d="M12.6,12,8,7.4,9.4,6l6,6-6,6L8,16.6,12.6,12Z" fill="#ababab"/>
                </svg>
...
<button
    class="bg-[#37C6F4] text-lg text-[#1E1D57] px-10 py-3 rounded-full text-sm w-[286px] font-medium 
    ...
    <!-- MAP SECTION -->
     <section class=" px-6 px-6 mb-16 mt-[40px] lg:px-16">
...
<!-- Comprehensive water PPP knowledge in a format that works for you  -->
    <section
        class="relative bg-[linear-gradient(106deg,#37C6F4_0%,#5CD3CE_100%)] bg-no-repeat bg-left-top opacity-100 text-black py-10 md:py-24 ">
        <div class="max-w-7xl mx-auto mb-16 flex flex-col md:flex-row justify-between items-start md:items-end md:gap-8 px-6 md:px-12 ">
            ...
            <a href="https://water-hub.ecareinfoway.com/resources" class="group inline-flex items-center text-[#37C6F4] mt-6 md:mt-0 font-medium  whitespace-nowrap bg-[#1E1D57] rounded-[15px] py-[10px] px-[27px] 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="ml-2 transition-all duration-200 fill-[#37C6F4] group-hover:fill-[#1E1D57]">
