<div class="filter-top pb-6">
    <ul class="flex flex-col gap-3">
        ...
        <li>
            <a href="javascript:void(0)" class="flex gap-2"><span class="material-symbols-outlined">emoji_objects</span>All case studies
            </a>
        </li>
    </ul>
</div>
    ...
    <ul class="space-y-4">
        <li class="category-with-sub border border-[#1E1D57] rounded-[25px] px-3 py-2 bg-white">
            ...
            <ul class="sub-cat space-y-1">
                <li><a href="javascript:void(0)" class="text-[#868686]">Sub category topic 1</a></li>
                <li><a href="javascript:void(0)" class="text-[#868686]">Sub category topic 2</a></li>
                <li><a href="javascript:void(0)" class="text-[#868686]">Sub category topic 3</a></li>
            </ul>
        </li>
        ...
        <li class="border border-[#1E1D57] rounded-[25px] px-3 py-2 bg-white">
            <a href="javascript:void(0)" class="flex gap-2"><span class="material-symbols-outlined">water_drop</span>Management
            </a>
        </li>
    </ul>
</div>
